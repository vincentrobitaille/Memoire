...
:::: {.fragment .fade-in}
::: {.fragment .semi-fade-out}
Estimation de l'effet d'interactions sur les dépenses à l'aide de lag spatial[@case1993a]
:::
::::
...
:::: {.fragment .fade-in}
::: {.fragment .semi-fade-out}
Interactions significatives (Allers & Elhorst, 2005) ???
:::
::::
...
:::: {.fragment .fade-in}
::: {.fragment .semi-fade-out}
-   Critiqué pour ses hypothèses très exigeantes[@bewley1981b]
:::
::::

::: {.fragment .fade-in}
-   Résultats empiriques mixtes concernant les hypothèses et implications [@dowding1994a]
:::
...
:::: {.fragment .fade-in}
::: {.fragment .semi-fade-out}
-   Effet positif et important de l'interactions dans les dépenses des états américains [@case1993b]
:::
::::

:::: {.fragment .fade-in}
::: {.fragment .semi-fade-out}
-   Séparation des effets *yardstick* et *spill over* [@bordignon2003a] (Italie)
...
:::: {.fragment .fade-in}
::: {.fragment .semi-fade-out}
-   Pas de preuve solide d'interdépendance dans les municipalités finlandaises [@lyytikäinen2012a]
:::
::::
...
:::: {.fragment .fade-in}
::: {.fragment .semi-fade-out}
Estimation des effets d'interaction à l'aide de modèles spatiaux censurés [@porto2013a]
:::
::::
...
:::: {.fragment .fade-in}
::: {.fragment .semi-fade-out}
Équilibre de Nash: information complète [@yang2018a]
:::
::::
